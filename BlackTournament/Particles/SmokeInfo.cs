...
namespace BlackTournament.Particles
{
    class SmokeInfo:TextureParticleAnimationInfo
    {
        ...
        public override Vector2f Velocity { get => _Speed != 0 ? VectorExtensions.VectorFromLookup(_Core.Random.NextFloat(0, 360), _Speed) : Velocity; set => base.Velocity = value; }
        public override float RotationVelocity { get => _Core.Random.NextFloat(-25, 25); set => base.RotationVelocity = value; }
